...
{{--    <!-- Sidebar -->--}}
{{--    <aside id="sidebar" class="fixed top-0 left-0 w-64 h-full bg-white shadow-lg transition-transform transform">--}}
...
{{--            <ul>--}}
{{--                <li class="mb-4">--}}
{{--                    <button class="w-full text-left" onclick="toggleMenu('menu1')">Parent 1</button>--}}
{{--                    <ul id="menu1" class="hidden pl-4">--}}
{{--                        <li><a href="#">Child 1</a></li>--}}
{{--                        <li><a href="#">Child 2</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li class="mb-4">--}}
{{--                    <button class="w-full text-left" onclick="toggleMenu('menu2')">Parent 2</button>--}}
{{--                    <ul id="menu2" class="hidden pl-4">--}}
{{--                        <li><a href="#">Child 1</a></li>--}}
{{--                        <li><a href="#">Child 2</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
...
{{--    <!-- Hamburger Icon -->--}}
{{--    <button id="open-btn" class="fixed top-4 left-4 text-white bg-gray-800 p-2 rounded hidden">--}}
{{--        &#9776; <!-- Hamburger icon -->--}}
{{--    </button>--}}
...
{{--    // Sidebar is open by default, so the open button is hidden--}}
...
{{--                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Enjam</span><!-- Institute Short Name-->--}}
{{--                </a>--}}
