...
{{--    <!-- Sidebar -->--}}
{{--    <aside :class="{'translate-x-0': open, '-translate-x-full': !open}" class="fixed z-30 inset-y-0 left-0 w-64 bg-white shadow-md transform transition-transform duration-300 ease-in-out">--}}
{{--        <div class="p-6">--}}
{{--            <button @click="open = !open" class="text-gray-600 hover:text-gray-900 float-right">--}}
